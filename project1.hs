...
mondrian x y p w h (r:s:rest) (h1:h2:h3) g c1 c2 c3
  | hs && vs           = b_split x y p (w) h rest h3 g c1 c2 c3
  | hs                 = h_split x y p (w) h rest h3 g c1 c2 c3
  | vs                 = v_split x y p (w) h rest h3 g c1 c2 c3
  | p <= 0             = c_curl x y p (w) h rest h3 g c1 c2 c3
...
--
randomColor :: Int -> Int -> Int -> Int -> Int -> Float -> Float -> Bool -> [Char] -> [Char] -> [Char] -> String

randomColor x y p w h r h1 g c1 c2 c3 
 | g == True = gradientColor x y p w h h1 r g c1 c2 c3
...
gradientColor :: Int -> Int -> Int -> Int -> Int -> Float -> Float -> Bool -> [Char] -> [Char] -> [Char] -> String
gradientColor x y p w h r h1 g c1 c2 c3 
 | r >= 1 = gradientColor x y p w h (r/10) h1 g c1 c2 c3
 | head c1 == '1' && head c2 == '1' && head c3 == '1' = fromList r (oranges ++ greys ++ whites)
 | head c1 == '1' && head c2 == '1' && head c3 == '2' = fromList r (oranges ++ greys ++ yellows)
 | head c1 == '1' && head c2 == '1' && head c3 == '3' = fromList r (oranges ++ greys ++ reds)
 | head c1 == '1' && head c2 == '2' && head c3 == '1' = fromList r (oranges ++ pinks ++ whites)
